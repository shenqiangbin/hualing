<%@ Page Language="C#" AutoEventWireup="true" CodeFile="adFloatingManage.aspx.cs" Inherits="admin_adFloatingManage" %>
...
<body>
    ...
    <div id="main">
      <div class="ctrl">
        <a href="adFloatingEdit.aspx" class="btn">新增</a>
        ...
        <asp:Repeater ID="Repeater1" runat="server" EnableTheming="false" onitemdatabound="Repeater1_ItemDataBound">
          <ItemTemplate>
            <tr>
              ...
              <td>
                <a href="adFloatingEdit.aspx?pkid=<%#Eval("Pkid")%><%= param %>" class="icon icon_edit" title="编辑"></a>
                <div class="operation">
