<%@ Page Language="C#" AutoEventWireup="true" CodeFile="cardManage.aspx.cs" Inherits="admin_cardManage" %>
...
<body>
    ...
    <div id="top">
      <div class="help">
        <table>
          <tr>
            <td>
              卡号 <input id="CardNo" type="text" class="text" runat="server" enableviewstate="false" />
              ...
              <select id="Sold" runat="server"></select>
    ...
    <div id="main">
      <div class="ctrl">
        <a href="cardEdit.aspx" class="btn">新增</a>
        <a href="cardImport.aspx" class="btn">批量导入</a>
        <a href="javascript:;" onclick="operate('sold', null, '<%= param %>');" class="btn">已售/未售</a>
        ...
        <asp:Repeater ID="Repeater1" runat="server" EnableTheming="false" onitemdatabound="Repeater1_ItemDataBound">
          <ItemTemplate>
            <tr>
              ...
              <td>
                <a href="cardEdit.aspx?pkid=<%#Eval("Pkid")%><%= param %>" class="icon icon_edit" title="编辑"></a>
                <div class="operation">
