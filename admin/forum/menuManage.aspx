<%@ Page Language="C#" AutoEventWireup="true" CodeFile="menuManage.aspx.cs" Inherits="admin_forum_menuManage" %>
...
<body>
    ...
    <div id="main">
      <div class="ctrl">
        <a href="menuEdit.aspx" class="btn">新增</a>
        <a href="javascript:;" onclick="formSubmit()" class="btn">全部保存</a>
        <a href="javascript:;" onclick="operate('reco', null, null);" class="btn">推荐/取消</a>
      ...
      <table class="tree">
        ...
        <tr lv="1" rank="last">
          <td></td>
          <td colspan="4"><a href="javascript:;" onclick="addMenu($(this), 0);" class="icon2 icon_add"> 新增菜单</a></td>
        </tr>
      </table>
      <div class="ctrl"></div>
