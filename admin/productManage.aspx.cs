...
public partial class admin_productManage : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!bll_admin.RuleAuth("内训管理")) WebUtility.ShowError(WebUtility.ERROR101);
    ...
    protected void Repeater1_ItemDataBound(object sender, RepeaterItemEventArgs e)
    {
        ...
        ((HtmlGenericControl)e.Item.FindControl("Eval_Pic")).InnerHtml = "<a href=\"/ser/" + product.Pkid + ".html\" target=\"_blank\"><img src=\"" + product.Pic + "\" /></a>";
