<%@ Page Language="C#" AutoEventWireup="true" CodeFile="productManage2.aspx.cs" Inherits="admin_productManage2" %>
...
<body>
  ...
  <div id="top">
    ...
    <div id="main">
      <div class="ctrl">
        <a href="productEdit2.aspx?cid=<%=cid %>" class="btn">新增</a>
        ...
        <a href="javascript:;" onclick="window.location.href='?cid=<%=cid %>'" class="btn">显示全部</a>
          ...
          <ItemTemplate>
            <tr>
             ...
             <%--<td><%#Eval("Pv")%></td> --%>
              ...
              <td>
                <a href="productEdit2.aspx?pkid=<%#Eval("Pkid")%><%= param %>" class="icon icon_edit" title="编辑"></a>
                <div class="operation">
