<%@ Page Language="C#" AutoEventWireup="true" CodeFile="projectManage.aspx.cs" Inherits="admin_projectManage" %>
...
<body>
    ...
    <div id="top">
      <div class="help">
        <table>
          <tr>
            <td>
              <%= groupName %>名称 <input id="MyTitle" type="text" class="text" runat="server" enableviewstate="false" />
              ...
              <select id="IsHot" runat="server"></select>
    ...
    <div id="main">
      <div class="ctrl">
        <a href="projectEdit.aspx?gid=<%= Request["gid"] %>" class="btn">新增</a>
        <a href="javascript:;" onclick="operate('top', null, '<%= param %>');" class="btn">置顶/取消</a>
        <a href="javascript:;" onclick="operate('hot', null, '<%= param %>');" class="btn">推荐/取消</a>
        ...
        <asp:Repeater ID="Repeater1" runat="server" EnableTheming="false" onitemdatabound="Repeater1_ItemDataBound">
          <ItemTemplate>
            <tr>
              ...
              <td>
                <a href="projectEdit.aspx?pkid=<%#Eval("Pkid")%><%= param %>" class="icon icon_edit" title="编辑"></a>
                <div class="operation">
