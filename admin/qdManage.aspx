<%@ Page Language="C#" AutoEventWireup="true" CodeFile="qdManage.aspx.cs" Inherits="admin_articleManage" %>
...
<body>
    ...
    <div id="top">
      <div class="help">
        <table>
          <tr>
            <td>
              标题 <input id="MyTitle" type="text" class="text" runat="server" enableviewstate="false" />
    ...
    <div id="main">
      <div class="ctrl">
        <a href="qdEdit.aspx?cid=35" class="btn">新增</a>
       <%-- <a href="javascript:;" onclick="operate('head', null, '<%= param %>');" class="btn">头条/取消</a>--%>
        ...
        <a href="javascript:;" onclick="window.location.href='?cid=35'" class="btn">显示全部</a>
        ...
        <asp:Repeater ID="Repeater1" runat="server" EnableTheming="false" onitemdatabound="Repeater1_ItemDataBound">
          <ItemTemplate>
            <tr>
              ...
              <td>
                <a href="qdEdit.aspx?pkid=<%#Eval("Pkid")%><%= param %>" class="icon icon_edit" title="编辑"></a>
                <div class="operation">
