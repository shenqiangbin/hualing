...
public partial class artlist : System.Web.UI.Page
{
    ...
    private void BindInfo()
    {
        ...
        QianZhu.Utility.Pagination pagination = new QianZhu.Utility.Pagination(Request.QueryString["page"], iRecordsTotal, iPageSize, "/artlist/" + category.Pkid.ToString() + "/page/$p/", false);
