...
public partial class club : System.Web.UI.Page
{
    ...
    private void BindInfo()
    {
        ...
        QianZhu.Utility.Pagination pagination = new QianZhu.Utility.Pagination(Request.QueryString["page"], iRecordsTotal, iPageSize, "/club/" + category.Pkid.ToString() + "/page/$p/", false);
