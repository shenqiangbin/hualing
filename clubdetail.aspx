<%@ Page Title="" Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true" CodeFile="clubdetail.aspx.cs" Inherits="clubdetail" EnableViewState="false" %>
...
<div class="m2new_info">
 发布时间：<%=QianZhu.Utility.DateHelper.ToShortDate(model.Pubdate) %>
<%if (category.Pkid == 7 || category.Pkid == 6)
  {%>
      &nbsp;&nbsp; 来源：<%= model.Source %> &nbsp;&nbsp; 发布者：<%= model.Author %> 
  <%} %>
</div>
