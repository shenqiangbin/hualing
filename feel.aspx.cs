...
public partial class feel : System.Web.UI.Page
{
    //建立业务逻辑层实例
    ...
    private void BindInfo()
    {
        ...
        QianZhu.Utility.Pagination pagination = new QianZhu.Utility.Pagination(Request.QueryString["page"], iRecordsTotal, iPageSize, "/feel/" + category.Pkid.ToString() + "/page/$p/", false);
