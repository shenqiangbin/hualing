...
public partial class main : System.Web.UI.MasterPage
{
    ...
    protected List<AdFixedModel> adFixedList = new List<AdFixedModel>();  //页面底部
    protected List<AdFixedModel> adFixedList1 = new List<AdFixedModel>();  //页面底部2
    protected List<AdFixedModel> adFixedList2 = new List<AdFixedModel>();  //页面底部3
    protected List<AdFixedModel> adFixedList3 = new List<AdFixedModel>();  //页面底部4
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
       // pageSection = bll_pageSection.GetModel("3");
        bll_config.Load(new string[] { "pageTitle", "headScript", "footScript", "foot", "foreLogo", "hotline" });
    ...
    private void BindInfo()
    {
        ...
        sqlWhereList.Add(new SqlWhere(SiteMenuModel.FATHERID, SqlWhere.Oper.Equal, 1));
        SiteMenuList = bll_siteMenu.GetList(1, 12, fieldList, sqlWhereList, null);

        //新手必读
        sqlWhereList.Clear();
        sqlWhereList.Add(new SqlWhere(AdFixedModel.ENABLED, SqlWhere.Oper.Equal, true));
        sqlWhereList.Add(new SqlWhere(AdFixedModel.GROUPID, SqlWhere.Oper.Equal, 11));
        adFixedList = bll_adFixed.GetList(sqlWhereList);
        //操作指南
        sqlWhereList.Clear();
        sqlWhereList.Add(new SqlWhere(AdFixedModel.ENABLED, SqlWhere.Oper.Equal, true));
        sqlWhereList.Add(new SqlWhere(AdFixedModel.GROUPID, SqlWhere.Oper.Equal, 12));
        adFixedList1 = bll_adFixed.GetList(sqlWhereList);
        //
        sqlWhereList.Clear();
        sqlWhereList.Add(new SqlWhere(AdFixedModel.ENABLED, SqlWhere.Oper.Equal, true));
        sqlWhereList.Add(new SqlWhere(AdFixedModel.GROUPID, SqlWhere.Oper.Equal, 13));
        adFixedList2 = bll_adFixed.GetList(sqlWhereList);
        //选课缴费
        sqlWhereList.Clear();
        sqlWhereList.Add(new SqlWhere(AdFixedModel.ENABLED, SqlWhere.Oper.Equal, true));
        sqlWhereList.Add(new SqlWhere(AdFixedModel.GROUPID, SqlWhere.Oper.Equal, 14));
        adFixedList3 = bll_adFixed.GetList(sqlWhereList);
    }
