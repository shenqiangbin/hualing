...
public partial class path : System.Web.UI.Page
{
    ...
    private void BindInfo()
    {
        ...
        QianZhu.Utility.Pagination pagination = new QianZhu.Utility.Pagination(Request.QueryString["page"], iRecordsTotal, iPageSize, "/path/" + category.Pkid.ToString() + "/page/$p/", false);
