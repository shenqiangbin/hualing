<%@ Page Language="C#" AutoEventWireup="true" CodeFile="attachment.aspx.cs" Inherits="plugin_ueditor_dialogs_attachment_attachment" %>
    ...
    <script type="text/javascript">
        ...
        window.onload = function() {
            var settings = {
                ...
                post_params: { "ASPSESSID": "<%= Session.SessionID %>", "code": "<%= filespec.Code %>", "fileNameFormat": editor.options.fileNameFormat }, //解决session丢失问题
                file_size_limit: "<%= filespec.Filesize %> KB",     //文件大小限制，此处仅是前端flash选择时候的限制，具体还需要和后端结合判断
                file_types: "<%= filespec.FileExt %>",              //允许的扩展名，多个扩展名之间用分号隔开，支持*通配符
                file_types_description: "Files",                     //扩展名描述
