<%@ Page Language="C#" AutoEventWireup="true" CodeFile="image.aspx.cs" Inherits="plugin_ueditor_dialogs_image_image" %>
    ...
    <div class="wrapper">
        <div id="imageTab">
            ...
            <div id="tabBodys" class="tabbody">
                ...
                <div id="imgManager" class="panel" style="display:none;">
                    <div id="imageList"><var id="lang_imgLoading"></var></div>
                </div>
                <div id="imgSearch" class="panel" style="display:none;">
    ...
    <script type="text/javascript">
        ...
        utils.domReady(function() {
            var flashOptions = {
                ...
                ext: '{"code":"<%= filespec.Code %>", "param2":"value2"}',   //可向服务器提交的自定义参数列表
                fileType: '{"description":"Files (<%= filespec.FileExt %>)", "extension":"<%= filespec.FileExt %>"}', //上传文件格式限制
                ...
                maxSize: <%= filespec.Filesize / 1000.0 %>,             // 文件的最大体积,单位M
                compressSize: 2,                                        // 上传前如果图片体积超过该值，会先压缩,单位M
                maxNum: 5,                                              // 单次最大可上传多少个文件
