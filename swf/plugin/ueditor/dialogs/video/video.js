    ...
    */
    ...
    function initUpload() {
        var settings = {
            ...
            post_params: { "ASPSESSID": sessionId, "code": filespecCode, "param2": "value2" },  //可向服务器提交的自定义参数列表
            file_size_limit: filespecSize + " KB",              //文件大小限制，此处仅是前端flash选择时候的限制，具体还需要和后端结合判断
            file_types: filespecExt,                            //允许的扩展名，多个扩展名之间用分号隔开，支持*通配符
