...
public class fileUp : IHttpHandler
{
    ...
    {
        string state = "SUCCESS", fileUrl = String.Empty, fileType = String.Empty, oriName = String.Empty;
        ...
        try
        {
            ...
            else
            {
                ...
                if (state == "SUCCESS")
                {
                    ...
                    fileUrl = virPath + filename;
                    mediaLib.FilePath = fileUrl;
            ...
            mediaLib.FileType = MediaLib.FileType.Attachment;
        ...
        context.Response.Write("{'state':'" + state + "','url':'" + fileUrl + "','fileType':'" + fileType + "','original':'" + oriName + "'}");
    }
