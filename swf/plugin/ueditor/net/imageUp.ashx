...
public class imageUp : IHttpHandler
{
    ...
    {
        string state = "SUCCESS", imgUrl = String.Empty, title = String.Empty, oriName = String.Empty;
        ...
        try
        {
            ...
            else
            {
                ...
                if (state == "SUCCESS")
                {
                    ...
                    imgUrl = virPath + filename;
                    mediaLib.FilePath = imgUrl;
            ...
            title = up.getOtherInfo(context, "pictitle");
            oriName = up.getOtherInfo(context, "fileName");

            //Insert the media library
            mediaLib.FileType = MediaLib.FileType.Image;
            mediaLib.Notes = title;
        ...
        context.Response.Write("{'url':'" + imgUrl + "','alt':'" + title + "','original':'" + oriName + "','state':'" + state + "'}");
    }
