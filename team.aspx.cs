...
public partial class team : System.Web.UI.Page
{
    ...
    private void BindInfo()
    {
        ...
        QianZhu.Utility.Pagination pagination = new QianZhu.Utility.Pagination(Request.QueryString["page"], iRecordsTotal, iPageSize, "/team/" + category.Pkid.ToString() + "/page/$p/", false);
