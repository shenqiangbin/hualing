...
public partial class video : System.Web.UI.Page
{
    ...
    private void BindInfo()
    {
        ...
        QianZhu.Utility.Pagination pagination = new QianZhu.Utility.Pagination(Request.QueryString["page"], iRecordsTotal, iPageSize, "/video/" + category.Pkid.ToString() + "/page/$p/", false);
